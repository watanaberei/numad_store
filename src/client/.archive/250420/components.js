...
// This would be in components.js
export const storeDetail = {
  render: (data) => {
    // console.log("[Components.js] storeDetail rendering with data:", data);
    const store = data;
    console.log("[components.storeDetail.data] store:", store);
    const storeId = store.slug || '';  // Use store slug as ID
    ...
    return `
     ...
     <div class="store-controls hero-controls array col01">
        ...
        <button class="store-controls user-action save" id="storeControls-save" onclick="storeActions.toggleSaveStore('${store.storeName}')">
          ${glyph.glyphControlSave}
          <span class="text03">Save</span>
        </button>
        <button class="store-controls user-action checkin" id="storeControls-checkin" onclick="storeActions.toggleCheckInStore('${store.storeName}')">
          ${glyph.glyphControlCheckin}
          <span class="text03">Check-in</span>
        </button>
      </div>
      <div id="impressions" class="user-impression disabled">
        <button id="userImpressionslike" class="impression-button like" data-store-id="${storeId}" onclick="storeActions.toggleImpression('${storeId}', 'like')">
          ${glyph.glyphSymbolUserImpressionLike}
          <span class="count">${data.likes || 0}</span>
        </button>
        <button id="userImpressionsdislike" class="impression-button dislike" data-store-id="${storeId}" onclick="storeActions.toggleImpression('${storeId}', 'dislike')">
          ${glyph.glyphSymbolUserImpressionDislike}
...
//       </div>
//        <div id="impressions" class="user-impression disabled">
//         <button id="userImpressions like" class="impression-button like" data-store-id="${storeId}" onclick="storeActions.toggleImpression('${storeId}', 'like')">
//           ${glyph.glyphSymbolUserImpressionLike}
//           <span class="count">${data.likes || 0}</span>
//         </button>
//         <button id="userImpressions dislike" class="impression-button dislike" data-store-id="${storeId}" onclick="storeActions.toggleImpression('${storeId}', 'dislike')">
//           ${glyph.glyphSymbolUserImpressionDislike}
//           <span class="count">${data.dislikes || 0}</span>
//         </button>
//       </div>
...
//     console.log("[Components.js] storeDetail rendering with data:", data);
//     const store = data;
//     const storeId = store.storeId || store.slug || '';  // Ensure we have a storeId
//     const storeType = Array.isArray(data.storeType)
//       ? data.storeType.map((type) => type.title).join(", ")
//       : "";
//     const costEstimate = data.costEstimate || "";
...
//           <span class="text03">Save</span>
//         </button>
//         <button class="store-controls user-action checkin" id="storeControls-checkin" onclick="storeActions.toggleCheckInStore('${store.storeName}', '${storeId}')">
//           ${glyph.glyphControlCheckin}
//           <span class="text03">Check-in</span>
//         </button>
//       </div>
//       <div id="userImpression" class="user-impression disabled">
//         <button class="impression-button like" data-store-id="${storeId}" onclick="storeActions.toggleImpression('${storeId}', 'like')">
//           $ {glyph.glyphControlLike}
//           <span class="count">${data.likes || 0}</span>
//         </button>
//         <button class="impression-button dislike" data-store-id="${storeId}" onclick="storeActions.toggleImpression('${storeId}', 'dislike')">
//           $ {glyph.glyphControlDislike}
//           <span class="count">${data.dislikes || 0}</span>
//         </button>
//       </div>
//    `;
