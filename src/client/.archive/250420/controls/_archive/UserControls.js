    ...
    <div class="user-controls">
      ...
      <div class="content">
        ...
        ${dividerV}
          ...
          <div id="impressions" class="impression disabled">
            <button class="impression-button like active" id="userImpression like" onclick="storeActions.toggleImpression('${store.storeId}', 'like')">
              <i class="icon-user-rating-like-12px"></i>
              <span class="label">${countDefault.render(count.countLike)}</span>
            </button>

            <button class="impression-button dislike" id="userImpression dislike" onclick="storeActions.toggleImpression('${store.storeId}', 'dislike')">
