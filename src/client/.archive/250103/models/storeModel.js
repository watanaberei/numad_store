...
// Instance methods
storeModel.methods.getYelpParams = function() {
  return {
...
// Static methods
storeModel.statics.fromContentfulData = function(data) {
  return new this(data);
};

// Export only the Store model and schema
const Store = mongoose.model('Store', storeModel);
export { Store, storeModel };

// Add method to update interactions
storeModel.methods.updateInteractions = async function(action) {
  if (action === 'like') {
