...
// src/server/route/routeProfile.js - Complete user profile routing system with blog posts
...
routeProfile.get('/user', authenticateToken, userController.getUserProfile);

// Update user profile
routeProfile.put('/user', authenticateToken, userController.updateUserProfile);

// Delete user account
routeProfile.delete('/user', authenticateToken, async (req, res) => {
  try {
...
routeProfile.get('/profile', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
...
routeProfile.put('/profile', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
...
routeProfile.post('/profile', authenticateToken, upload.fields([
...
routeProfile.post('/profile/picture', authenticateToken, upload.single('profilePicture'), async (req, res) => {
  try {
    const userEmail = req.user.email;
...
routeProfile.post('/settings', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
    const updates = req.body;
...
routeProfile.get('/api/user', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
...
routeProfile.get('/user/stores', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
...
routeProfile.get('/store', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
    console.log(`[UserAPI] Fetching store data for user: ${userEmail}`);
...
// 9. SEARCH USERS
routeProfile.get('/search', async (req, res) => {
  try {
...
routeProfile.post('/check-username', authenticateToken, async (req, res) => {
  try {
...
routeProfile.get('/@:username', async (req, res) => {
  try {
...
routeProfile.get('/@:username/activity', async (req, res) => {
  try {
    const { username } = req.params;
...
routeProfile.get('/@:username/places', async (req, res) => {
try {
  const { username } = req.params;
...
routeProfile.get('/@:username/posts', async (req, res) => {
try {
  const { username } = req.params;
...
routeProfile.get('/user/:username', async (req, res) => {
  try {
    const { username } = req.params;
...
routeProfile.put('/user/:username', authenticateToken, verifyUserOwnership, async (req, res) => {
  try {
...
// Upload profile picture
routeProfile.post('/user/:username/photo', authenticateToken, verifyUserOwnership, upload.single('profilePicture'), async (req, res) => {
  try {
    const user = req.profileUser;
...
routeProfile.post('/user/:username/follow', authenticateToken, async (req, res) => {
  try {
    const { username } = req.params;
...
routeProfile.post('/@:username/follow', authenticateToken, async (req, res) => {
  try {
    const { username } = req.params;
...
routeProfile.get('/user/:username/followers', async (req, res) => {
  try {
    const { username } = req.params;
...
routeProfile.get('/@:username/followers', async (req, res) => {
  try {
    const { username } = req.params;
    const { limit = 20, page = 1 } = req.query;
...
routeProfile.get('/user/:username/following', async (req, res) => {
  try {
    const { username } = req.params;
    const { limit = 50, page = 1 } = req.query;
...
routeProfile.get('/@:username/following', async (req, res) => {
  try {
    const { username } = req.params;
    const { limit = 20, page = 1 } = req.query;
...
// Get user stats
routeProfile.get('/user/:username/stats', async (req, res) => {
  try {
...
// 12. ENDORSE USER
routeProfile.post('/@:username/endorse', authenticateToken, async (req, res) => {
  try {
    const { username } = req.params;
...
routeProfile.post('/@:username/block', authenticateToken, async (req, res) => {
  try {
    const { username } = req.params;
...
routeProfile.get('/user/:username/stores', async (req, res) => {
  try {
    // const username = req.params.username;
    const { username } = req.params;
...
routeProfile.get('/user/blogs', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
...
routeProfile.get('/user/:username/blogs', async (req, res) => {
  try {
    const { username } = req.params;
...
routeProfile.post('/user/blog', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
...
// Save/unsave blog
routeProfile.post('/user/blog/save', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
...
// Like/unlike blog
routeProfile.post('/user/blog/like', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
...
routeProfile.post('/user/blogs/add', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
...
routeProfile.post('/user/blogs/:blogId/save', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
...
routeProfile.post('/user/blogs/:blogId/like', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
    const { blogId } = req.params;
...
routeProfile.post('/user/blogs/sync', authenticateToken, async (req, res) => {
  try {
    const userEmail = req.user.email;
...
// Add these endpoints to your routeProfile.js for debugging

// DIAGNOSTIC: List all users (remove in production)
routeProfile.get('/debug/users', async (req, res) => {
  try {
...
routeProfile.get('/debug/find-user/:partial', async (req, res) => {
  try {
...
routeProfile.post('/debug/create-test-user', async (req, res) => {
  try {
...
// Legacy endpoint
routeProfile.get('/user-profile', authenticateToken, userController.getUserProfile, async (req, res) => {
...
// Legacy endpoint
routeProfile.post('/user-profile', authenticateToken, userController.updateUserProfile, async (req, res) => {
  // Redirect to new endpoint
  console.log('[UserAPI] Legacy endpoint accessed, redirecting to /profile');
  return res.redirect('/api/profile');
});
