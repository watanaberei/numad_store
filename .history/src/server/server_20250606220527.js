...
// Use blog routes
app.use('/api/:username/blog/:slug', routeBlog);
...
// FIXED: Additional blog endpoints for compatibility
app.get('/api/geojson/blogs', async (req, res) => {
  try {
    console.log('[Server] Getting GeoJSON blogs data for HomeScreen');
...
// FIXED: Add this function to your server startup to ensure indexes are properly created
