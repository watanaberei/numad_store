...
// Make sure to add this BEFORE the app.use((err, req, res, next) error handler
...
//     // Start server
//     const port = process.env.SERVERPORT || 8080; // Using port 8080 to match socket.io in StoreScreen.js
//     app.listen(port, () => {
//       console.log(`Server running on port ${port}`);
//       console.log(`Store sync endpoint available at: http://localhost:${port}/api/stores/sync/:slug`);
//     });
