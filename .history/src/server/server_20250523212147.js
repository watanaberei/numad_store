...
function authenticateUser (req, res, next) {
 ...
 app.post('/api/blog', authenticateUser, async (req, res) => {
  try {
    ...
    const blogData = {
      slug: slug, // Use slug to match your model
      title,
    ...
    console.log('[Blog API] Blog created successfully:', blog.slug);
...
app.post('/api/blog/:slug', authenticateUser, async (req, res) => {
  try {
    ...
    const blog = await BlogModel.findOne({ slug: slug }); // Use slug
    ...
    console.log('[Blog API] Blog updated successfully:', blog.slug);
...
app.get('/api/blog/:slug', async (req, res) => {
  try {
    const blog = await BlogModel.findOne({ slug: req.params.slug }); // Use slug
