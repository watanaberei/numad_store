const config = {
  YELP_API_KEY: 'F1FDCQtwLKirjVxp00aRFDFkmGSnM5bLmuGa8q8AbXJeewRJfuMJ3CrrgaApmWtSojDTHoOYk_TiUrlltSlxXhlcpIHSwyxERtZWkPCNsuB59LeykZX8QfWToMwoaHYx',
  YELP_BASE_URL: 'https://api.yelp.com/v3',
  YELP_CLIENT_ID: 'eV46pIp9xffjqJ6gcGKydQ',
