...
const config = {
  YELP_API_KEY: process.env.YELP_API_KEY || '7RnqG5aXXNEoQ6WCLFtKkYzz1mw4r6BVuC4Y9AierRa7zvapi02NgwCOABGtsCHami1X9DwaMDEaUVGfHQK3OGCEtIifyUQFWIpno0ZITkrmTN7llxWa_NSRBLYeaHYx',
  YELP_BASE_URL: process.env.YELP_BASE_URL || 'https://api.yelp.com/v3',
  YELP_CLIENT_ID: process.env.YELP_CLIENT_ID || 'eV46pIp9xffjqJ6gcGKydQ',
