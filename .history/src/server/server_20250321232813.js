...
// Define a default slug for initialization
const defaultSlug = 'ca_orange-county_newport_blueBottle-coffee'; // Using one of the existing store slugs from the data

// Start the server with the default slug
