...
app.get('/api/stores/:slug', async (req, res) => {
  try {
    ...
    // Initialize server with this slug if not already initialized
    await initializeServer(slug);

    // Rest of the existing store fetch code...
...
// Start the server with a default store
const defaultSlug = 'ca_orange-county_newport_blueBottle-coffee';
initializeServer(defaultSlug).catch(error => {
