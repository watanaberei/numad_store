...
import { User, Store, storeOperations, connectDB } from "./data/mongodb/mongodb.js";
...
const initializeServer = async () => {
  try {
    ...
    const storeData = new data.StoreData();
    const slug = 'ca_orange-ca_los-angeles_long-beach_the-library'; // Example initial store
    ...
    if (!store) {
      ...
      if (freshStoreData) {
        // Save to MongoDB using findOneAndUpdate to handle race conditions
      ...
      // If store exists but is stale, update it
