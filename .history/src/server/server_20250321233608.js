...
// Start the server with the store from the URL
app.get('/:resource?/:slug?', async (req, res, next) => {
  const slug = req.params.slug;
  console.log('[Init] URL slug:', slug);

  // Initialize server with the slug from URL
  initializeServer(slug || 'ca_orange-county_newport_blueBottle-coffee').catch(error => {
