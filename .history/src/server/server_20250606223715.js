...
///////////////////////// REMOVED REDUNDANT BLOG ENDPOINTS /////////////////////////
// All blog endpoints are now handled by routeBlog.js
// Removed duplicate endpoints:
// - app.post('/api/blog/sync/:slug')
// - app.get('/api/blog/:slug') 
// - app.get('/api/blog')
// - app.post('/api/blog/sync/bulk')
// These are now handled in routeBlog.js with proper username/blog/slug routing
...
const initServer = async () => {
  try {
    ...
    app.listen(PORT, () => {
      ...
      console.log(`Blog API available at: http://localhost:${PORT}/api/:username/blog/:slug`);
      console.log(`Store API available at: http://localhost:${PORT}/api/stores`);
      console.log(`Available blog endpoints:`);
      console.log(`  - GET    /api/:username/blog/:slug           - Get single blog`);
      console.log(`  - POST   /api/:username/blog/:slug/view      - Record blog view`);
      console.log(`  - POST   /api/:username/blog/:slug/like      - Like/unlike blog`);
      console.log(`  - POST   /api/:username/blog/:slug/save      - Save/unsave blog`);
      console.log(`  - GET    /api/:username/blog/:slug/comments  - Get blog comments`);
      console.log(`  - POST   /api/:username/blog/:slug/comment   - Add blog comment`);
      console.log(`  - GET    /api/:username/blog/:slug/user-status - Get user interaction status`);
