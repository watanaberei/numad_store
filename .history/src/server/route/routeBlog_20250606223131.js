...
routeBlog.get('/:username/blog/:slug', async (req, res) => {
  try {
    ...
    // Find blog by slug and verify author
...
routeBlog.post('/:username/blog/:slug/view', authenticateToken, async (req, res) => {
  try {
    const { username, slug } = req.params;
...
///////////////////////// NEW: BLOG LIKE/UNLIKE /////////////////////////
routeBlog.post('/:username/blog/:slug/like', authenticateToken, async (req, res) => {
  try {
    const { username, slug } = req.params;
...
///////////////////////// NEW: BLOG SAVE/UNSAVE /////////////////////////
routeBlog.post('/:username/blog/:slug/save', authenticateToken, async (req, res) => {
  try {
    const { username, slug } = req.params;
    const userId = req.user.id;
...
routeBlog.get('/:username/blog/:slug/comments', async (req, res) => {
  try {
    const { username, slug } = req.params;
...
routeBlog.get('/:username/blog/:slug/user-status', authenticateToken, async (req, res) => {
  try {
    const { username, slug } = req.params;
    const userId = req.user.id;
