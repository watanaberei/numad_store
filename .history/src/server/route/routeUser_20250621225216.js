...
// Legacy endpoint
routeUser.get('/user-profile', authenticateToken, controllerUser.getUserProfile async (req, res) => {
...
// Legacy endpoint
routeUser.post('/user-profile', authenticateToken, controllerUser.updateUserProfile async (req, res) => {
  // Redirect to new endpoint
  console.log('[UserAPI] Legacy endpoint accessed, redirecting to /profile');
  return req.app.handle(req, res);
});
