...
const controllerProfile = require('../controllers/controllerUser');
...
// Legacy endpoint
routeUser.get('/user-profile', authenticateToken, controllerProfile.getUserProfile async (req, res) => {
...
// Legacy endpoint
routeUser.post('/user-profile', authenticateToken, controllerProfile.updateUserProfile async (req, res) => {
  // Redirect to new endpoint
  console.log('[UserAPI] Legacy endpoint accessed, redirecting to /profile');
  return req.app.handle(req, res);
});
