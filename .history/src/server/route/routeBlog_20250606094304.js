...
routeBlog.post('/:slug?', authenticateUser, upload.fields([
...
routeBlog.post('/sync/:slug', authenticateToken, async (req, res) => {
  try {
    const { slug } = req.params;
...
///////////////////////// UPDATE BLOG STATUS /////////////////////////
routeBlog.post('/:slug/status', authenticateToken, async (req, res) => {
  try {
    const { slug } = req.params;
...
///////////////////////// DELETE BLOG /////////////////////////
routeBlog.delete('/:slug', authenticateToken, async (req, res) => {
  try {
    const { slug } = req.params;
...
routeBlog.post('/:slug/status', authenticateUser, async (req, res) => {
  try {
    const { slug } = req.params;
    const { status } = req.body;
...
// Add comment to blog
routeBlog.post('/:slug/comment', authenticateUser, async (req, res) => {
  try {
    const { slug } = req.params;
