...
export class StoreData {
  constructor() {
    ...
    this.activeTags = [];
    this.yelp = Yelp; // Will be set when needed
    
    // Add debug logging
    console.log("[StoreData.constructor] Initialized with template:", this.store);
  }

  // Helper method to transform price
