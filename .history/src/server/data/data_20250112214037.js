...
export class StoreData {
  ...
  store(yelpData) {
    ...
    // Create store object using class methods
    const store = {
      hero: this.heroData(yelpData),
      overview: this.overviewData(yelpData),
      experience: this.experienceData(yelpData),
      service: this.serviceData(yelpData),
      business: this.businessData(yelpData),
      location: this.locationData(yelpData),
      yelpData: yelpData // Store original Yelp data
    };

    console.log("[StoreData.store] Created store object:", store);
    return store;
  }
};
