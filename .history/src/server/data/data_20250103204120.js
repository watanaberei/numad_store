...
export class StoreData {
  ...
  async getStoreBySlug(slug) {
    console.log("[StoreData.getStoreBySlug] Fetching store:", slug);
    try {
      ...
      const yelpStore = await yelp.getStoreData(storeParams);
      ...
      console.log("[StoreData.getStoreBySlug] Combined store data:", combinedStore);
