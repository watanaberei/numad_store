      ...
      const experience = 
        {
          ...
          area: this.areaData(yelpData)?.areaData.item || [] ? this.areaData(yelpData)?.areaData.item || [] : null,
          attribute: this.attributesData()?.attributesData ? this.attributesData()?.attributesData : null,
          text: this.textBlockData()?.textBlockData ? this.textBlockData()?.textblockData : null,
           // Ensure footerData.overview exists, otherwise use default object
          footer: this.footerData()?.overview || {
          contributionsCount: null,
          modifiedDate: null,
