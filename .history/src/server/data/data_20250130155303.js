...
export class StoreData {
  ...
  async getStoreBySlug(slug) {
    try {
      ...
      const storeParams = {
        ...
        storeLongitude: matchedStore.location?.geolocation?.lon || 0,
        storeLatitude: matchedStore.location?.geolocation?.lat || 0
      };
  ...
  transformYelpHours(yelpData) {
    try {
      console.log("transformYelpHours yelpData:", yelpData);
      ...
      console.error("transformYelpHours", "Error:", error);
      return {
        storeName: '',
        isOpen: false,
        currentTime: '',
