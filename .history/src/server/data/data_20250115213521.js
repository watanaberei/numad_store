...
export class StoreData {
  ...
  serviceCategoryData() {
    try {
      console.log("%01:[StoreData.serviceCategoryData] Starting to build service category data");
      ...
      console.log("%02:[StoreData.serviceCategoryData] Built categories:", Object.keys(categories));
      return categories;
    } catch (error) {
      console.error("[StoreData.serviceCategoryData] Error:", error);
      return null;
    }
  }
  ...
  areaData(yelpData) {
    try {
      console.log("%03:[StoreData.areaData] Processing Yelp data for areas:", yelpData?.name);
      ...
      console.log("%04:[StoreData.areaData] Generated area data:", areaData);
      return areaData;
    } catch (error) {
      console.error("[StoreData.areaData] Error:", error);
      return [];
    }
  }
