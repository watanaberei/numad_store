// At the top of your data.js file, update the import
...
export async function initializeData() {
  try {
    console.log('Initializing data from Yelp...');
    const businessId = 'smoking-tiger-cerritos-cerritos-2';
    const yelpData = await yelpApi.getStoreData(businessId);
    
    if (yelpData) {
      console.log('Successfully loaded Yelp data:', yelpData);
      // Here you can merge Yelp data with your existing data structure
      // store.item[0] = { ...store.item[0], ...yelpData };
    } else {
      console.log('Using fallback data - Yelp data unavailable');
    }
  } catch (error) {
...
// Example usage:
const businessId = 'smoking-tiger-cerritos-cerritos-2'; // Yelp business ID
const storeData = await yelp.yelpApi.getStoreData(businessId);
console.log('Store data:', storeData);

// Search example:
const searchResults = await yelp.yelpApi.searchBusinesses({
  term: 'coffee',
