...
export class StoreData {
  ...
  async getStoreBySlug(slug) {
    try {
      ...
      console.log("!05:[StoreData.getStoreBySlug] combinedStore:", combinedStore);
...
const neighborhoodAttributes =
  ...
  async store(slug) {
    try {
      ...
      // Create store object with default empty objects
      const store = {
        ...
        yelpData: yelpData || {},
        yelpFoodData: yelpFoodData || {},
        yelpFusionData: yelpFusionData || {},
        yelpSearchData: yelpSearchData || {},
        yelpPhoneData: yelpPhoneData || {},
        yelpMatchData: yelpMatchData || {},
        yelpDetailsData: yelpDetailsData || {},
        yelpDeliveryData: yelpDeliveryData || {},
        yelpServiceData: yelpServiceData || {},
        yelpInsightData: yelpInsightData || {}
      };

      return store;

    } catch (error) {
      console.error("[StoreData.store] Error:", error);
      // Return empty store object instead of null
      return {
        hero: {},
        overview: {},
        experience: {},
