...
export class StoreData {
  ...
  experience(yelpData) {
    console.log("[DEBUG] Building experience with yelpData:", yelpData);
      ...
      item: [
        {
          area: "Outside",
          links: {
            gallery: `/gallery/${this.category}`
          },
          images: this._buildAreaImages(yelpData)
        },
        {
          area: "Inside", 
          links: {
    ...
    console.log("[DEBUG] Created areaData:", areaData);
    ...
    return {
      ...
      area: areaData,
      attribute: this._buildAttributes(yelpData),
      text: this._buildTextBlock(),
      footer: {
        links: {
          gallery: `/gallery/${this.category}`
        }
  ...
  // Helper method to build area images
  _buildAreaImages(yelpData) {
    console.log("[DEBUG] Building area images from:", yelpData);
    
    if (!yelpData || !yelpData.photos) {
      console.log("[DEBUG] No photos found in yelpData");
      return [];
    }

    return yelpData.photos.map(photoUrl => ({
      id: photoUrl,
      impressions: {
        users: "",
        likes: "",
