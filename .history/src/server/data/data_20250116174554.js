...
export class StoreData {
 ...
 categoryData() {
  ...
  location(yelpData) {
    try {
      const YelpData = yelpData;
      console.log("!!!!location YelpData", YelpData);
      const storeLocation = {
      ...
      const location =
        {
          ...
          neighborhood: this.neighborhood(YelpData) ? this.neighborhood(YelpData) : null,
          attribute: this.neighborhood?.attribute?.attr || [] ? this.neighborhood?.attribute?.attr() || [] : null,
