...
export const store = {
      ...
      overview: [
        {
          overviewHeaderData: headerData?.overview ? headerData?.overview : null,

          // Ensure overviewSummaryData is provided or fallback to null
          overviewSummaryData: overviewSummaryData ? overviewSummaryData : null,
          
          // Ensure textBlockData is provided or fallback to null
          overviewTextData: textBlockData ? textBlockData : null,
          
          // Ensure footerData.overview exists, otherwise use default object
          overviewFooterData: footerData?.overview || {
      ...
      service: [
        {
          serviceHeaderData: headerData?.service ? headerData?.service : null,

          
          // Ensure overviewSummaryData is provided or fallback to null
          serviceCategoryData: attributesData ? attributesData : null,
          // Ensure textBlockData is provided or fallback to null
          serviceTextData: textBlockData ? textBlockData : null,

          // Ensure footerData.overview exists, otherwise use default object
          serviceFooterData: footerData?.service || {
            contributionsCount: null,
            modifiedDate: null,
            modifiedTime: null,
            commentsCount: null,
      ...
      experience: [
        {
          experienceHeaderData: headerData?.experience ? headerData?.experience : null,

          experienceAreaData: areaData ? areaData : null,
          experienceCategoryData: attributesData ? attributesData : null,
          // experience:
          // Ensure overviewSummaryData is provided or fallback to null

          // Ensure textBlockData is provided or fallback to null
          experienceTextData: textBlockData ? textBlockData : null,

          // Ensure footerData.overview exists, otherwise use default object
          experienceFooterData: footerData?.experience || {
            contributionsCount: null,
            modifiedDate: null,
            modifiedTime: null,
            commentsCount: null,
      ...
      business: [
        {
          businessHeaderData: headerData?.business ? headerData?.business : null,

          businessAreaData: areaData ? areaData : null,
          businessCategoryData: attributesData ? attributesData : null,
          // experience:
          // Ensure overviewSummaryData is provided or fallback to null

          // Ensure textBlockData is provided or fallback to null
          businessTextData: textBlockData ? textBlockData : null,

          // Ensure footerData.overview exists, otherwise use default object
          businessFooterData: footerData?.business || {
            contributionsCount: null,
            modifiedDate: null,
            modifiedTime: null,
            commentsCount: null,
