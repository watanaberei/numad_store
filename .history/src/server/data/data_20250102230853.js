...
export class StoreData {
  ...
  async getStoreBySlug(slug) {
    try {
      ...
      // Filter for valid stores and find matching store
      const validStores = stores.filter((store) => store.slug);
      console.log("[StoreData.getStoreBySlug] Valid stores:", validStores);
