...
// const storeYelp = 'Smoking Tiger Bread Factory';
export async function initializeData() {
  try {
    // Use the correct business ID
    const storeYelp = storeYelp;

    const storeName = storeYelp.name;
    const storeLocation = storeYelp.location;
    console.log('Fetching data for:', storeName);
    
    const storeData = await yelpApi.getStoreData(storeYelp);
    ...
    return { storeData: null, searchResults: [] };
  }
}
