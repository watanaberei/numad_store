...
export class StoreData {
 ...
 categoryData() {
  ...
  mapRadiusData(coordinates) {
    try {
      console.log("Generating map radius data with coordinates:", coordinates);
      ...
      const mapRadiusData = {
        address: coordinates.address || "11900 South St Ste 134",
        city: coordinates.city || "Cerritos",
        state: coordinates.state || "CA",
        stores: [
          {
            type: "Feature",
            geometry: {
          ...
          // ... other nearby stores will be added from Yelp data
        ]
      };

      return mapRadiusData;
    } catch (error) {
      console.error("Error in mapRadiusData:", error);
      return null;
    }
  }
