...
export class StoreData {
  ...
  async store(slug) {
    try {
      ...
      const store = {
        hero: this.heroData(yelpData) || yelpData.details,
        overview: yelpData.overview || [],
        experience: yelpData.experience || [],
        service: yelpData.service || [],
        business: yelpData.business || [],
        location: yelpData.location || {},
