  ...
  async getStoreBySlug(slug) {
    try {
      ...
      const yelpDataParams = {
        storeId: combinedStore.storeId,
        storeAlias: combinedStore.storeAlias,
        storeName: combinedStore.storeName,
        storeCity: combinedStore.storeCity,
        storeState: combinedStore.storeState,
      }
