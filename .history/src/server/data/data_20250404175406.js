...
const neighborhoodAttributes =
  ...
  // Helper function to transform Yelp hours data
  hero(yelpData, storeData) {
    try {
      const YelpData = yelpData;
      const Store = storeData;
      console.log("[Data.hero]hero Store", Store);
      // console.log(
  ...
  async store(slug) {
    try {
      ...
      // const Store = await this.matchedStore;
      
      // Create store object combining all data
      const store = {
        hero: this.hero(yelpData.basic, matchedStore.basic),
