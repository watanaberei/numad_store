...
const storeOperations = {
  ...
  async updateStoreData(storeId, updates, source) {
    ...
    try {
      ...
      console.log(`Found ${storeData?.length || 0} stores to sync`);
      ...
      for (const store of storeData) {
        try {
          ...
          errorCount++;
          console.error(`Error syncing store ${store.slug}`);
        }
      }

      console.log(`Sync complete: ${syncedCount} stores synced, ${errorCount} errors`);
