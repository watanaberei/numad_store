...
const storeOperations = {
  ...
  async syncStoreData(slug) {
    try {
      ...
      console.log(`Syncing store: ${slug}`);
      ...
      // Format store document
      const storeDoc = {
        storeId: storeData.sys?.id || `store-${Date.now()}`,
        slug: storeData.slug,
        title: storeData.title,
        sys: storeData.sys,
        featured: storeData.featured,
        storeNickname: storeData.storeNickname,
        ...
        overviewTitle: storeData.overviewTitle,
        ...
        snippet: storeData.snippet,
        content: storeData.content,
        media: storeData.media,
        variant: storeData.variant,
