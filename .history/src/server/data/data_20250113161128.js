...
export class StoreData {
  ...
  async experience(yelpData) {
    try {
      const headerData = this.headerData(data);
      ...
      const location =
        {
          ...
          area: this.areaData ? this.areaData : null,
          attribute: this.location.locations[0] ? this.location.locations[0] : null,
  ...
  async store(slug) {
    try {
      ...
      const store = {
        serviceCategoryData: this.serviceCategoryData(yelpData) || yelpData,
        mapRadiusData: this.mapRadiusData(yelpData) || yelpData,
        hero: this.hero(yelpData) || yelpData,
        overview: this.overview(yelpData) || yelpData,
        experience: this.experience(yelpData) || yelpData,
        service: this.service(yelpData) || yelpData,
        business: this.business(yelpData) || yelpData,
        location: this.location(yelpData) || yelpData,
