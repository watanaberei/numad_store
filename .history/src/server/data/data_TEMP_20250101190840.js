...
const yelpData = await import { yelpApi } from "./yelp/yelpApi.js";
.searchBusinesses('Smoking Tiger Bread Factory', 'cerritos, ca');
...
// categoryData[0].links.image
// categoryData[0].items[0].source.links.source
// categoryData[0].items[0].source.thumbnail.post.poster.links.profile
export const categoryData = {
  matcha: {
    rank : 1,
...
export const store = {
      ...
      overview: [
        {
          headerData: headerData?.overview ? headerData?.overview : null,

          // Ensure summaryData is provided or fallback to null
          summaryData: summaryData ? summaryData : null,
          
          // Ensure textBlockData is provided or fallback to null
          textData: textBlockData ? textBlockData : null,
          
          // Ensure footerData.overview exists, otherwise use default object
          footerData: footerData?.overview || {
      ...
      service: [
        {
          headerData: headerData?.service ? headerData?.service : null,
      ...
      //     header: "experience",
      //     summary: {
      //       card: summaryData ? summaryData : null,
