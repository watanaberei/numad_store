...
export const yelp = {
  ...
  transformBusinessData(yelpData) {
    console.log("[yelp.transformBusinessData] Starting transformation of:", yelpData);
    if (!yelpData) {
      console.warn("[yelp.transformBusinessData] No data provided");
      return null;
    }
    ...
    console.log("[yelp.transformBusinessData] Transformed data:", transformedData);
    return transformedData;
  },

  transformMediaGallery(yelpData) {
  ...
  transformStoreServices(yelpData) {
