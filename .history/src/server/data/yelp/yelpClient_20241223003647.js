...
// filepath: /Users/reiwatanabe/Downloads/numad/components/numad_store/src/server/data/yelp/yelpClient.js
import dotenv from "dotenv";
import path from "path";

console.log("debug log: Initializing Yelp API client", process.env.YELP_BASE_URL;);
