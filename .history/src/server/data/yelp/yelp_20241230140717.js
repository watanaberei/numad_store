...
export const yelp = {
  async getStoreData(businessId) {
    try {
      ...
      const data = this.transformBusinessData(data);
      console.log("[yelp.getStoreData] Final transformed data:", data);
      return data;
    } catch (error) {
  ...
  businessData(yelpData) {
    ...
    console.log("[yelp.transformBusinessData] Transformed data:", data);
    return data;
  },
