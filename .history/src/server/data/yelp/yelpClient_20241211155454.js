...
class YelpClient {
  ...
  async getBusinessDetails(businessId) {
    ...
    try {
      ...
      // Fetch from API
      const data = await this.fetchYelpAPI(`/businesses/${businessId.replace(/\s+/g, '-').toLowerCase()}`);
  ...
  async getBusinessReviews(businessId) {
    ...
    try {
      ...
      const data = await this.fetchYelpAPI(`/businesses/${businessId.replace(/\s+/g, '-').toLowerCase()}/reviews`);
