...
async function getBusinessInsightsData(params) {
  try {
...
async function getServiceOfferingsData(params) {
  try {
...
async function getFoodDeliverySearchData(params) {
  try {
...
async function getBusinessDetailsData(params) {
  try {
...
async function getBusinessMatchData(params) {
  try {
