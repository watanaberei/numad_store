...
export const yelpApi = {
  async getStoreData(businessName, location = 'cerritos, ca') {
    try {
      console.log('Searching for store:', businessName, 'in', location);
      const yelpData = await yelpClient.searchBusiness(businessName, location);
      if (!yelpData) {
