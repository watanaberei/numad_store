...
const neighborhoodAttributes =
  ...
  heroData(yelpData) {
    try {
      console.log("[StoreData.heroData] Processing Yelp data:", yelpData);
      
      if (!yelpData) {
        console.warn("[StoreData.heroData] No Yelp data available");
        return null;
      }
      ...
      console.log("[StoreData.heroData] Processed data:", heroData);
      return heroData;
    } catch (error) {
