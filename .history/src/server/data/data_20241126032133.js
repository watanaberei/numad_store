...
export async function initializeData() {
  try {
    // Example initialization with Yelp data
    const businessId = 'smoking-tiger-bread-factory-cerritos'; // Updated business ID
    const storeData = await yelpApi.getStoreData(businessId);
    console.log('Yelp data loaded:', storeData);
    ...
    // Removed undefined businessData reference
    console.log('Data initialization complete:', { storeData, searchResults });
    
    return { storeData, searchResults };
  } catch (error) {
...
const businessData = await yelpService.getBusinessDetails('your-business-id');
