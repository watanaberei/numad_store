...
import * as controlTimeline from '../components/controls.js';
import * as components from '../components/components.js';

// const controlTimeline = controlTimeline;
...
export const businessHours = {
  render: (schedule) => {
    ...
    const hoursData = Array.from({ length: 24 }, (_, i) => {
      ...
      const isOpen = schedule[0]?.open.some(slot => 
        slot.day === currentDay &&
      ...
      <div class="business-hours col04">
        <div class="container col04">
          <div class="datavis grid08-overflow">
            ${hoursData.map(item => `
              <div class="col01 ${item.status} datavis-item${item.isCurrent ? ' active current' : item.status === 'active' ? ' active' : ' inactive'}">
