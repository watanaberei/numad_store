...
import DineScreen from '../../screens/Home/DineScreen.js';
import { modalAccount } from '../../components/modal/modal.js';
...
const HeaderHome = {
  render: async () => {
    ...
    return `
          <nav class="grid05 nav navigation container nav-top">
            <section class="col05 base nav-main">
          
              <div class="col03 nav-main-left left">
                <div class="nav-main-logo">
                    <!-- hamburger --> 
      
                    <a class="nav-topbar-logo-container word" href="/">
                      <i class="brand-logomark-18px"></i>                   
                      <span class="text03 bold">✸N</span>
                    </a>
              ...
              <div class="col03 nav-main-center search-container">
                  ...
                  <div class="search senta">
                    ...
                    <div class="searchBar-cta">
                      <div class="searchBar-cta-container">
                        <button id="search-btn" class="text03"><i class="cta menu-icon icon-Search-21px"></i></button>
                      </div>
                    </div>
                    <!--CTA-->
                ...
                <div class="col01 nav-main-right right">
                  <div class="nav-main-right-container">
                    <a href="/account">
                      <button id="btn-account" class="text03">
                        Account
                      </button>
                    </a>
                    ${localStorage.getItem('accessToken') !== null ? `
                      <button id="btn-logout" class="text03">
                        Log out
                      </button>
                    ` : ''}
                  </div>
