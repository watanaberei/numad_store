...
import { modals, auth } from '../modal.js'; // Fixed import path
import * as components from '../../components/components.js';
import * as elements from '../../elements.js'; // Fixed import path
...
const HeaderHome = {
  ...
  after_render: async (map) => {
    console.log('[HeaderHome] Initializing after_render');
    ...
    if (isAuthenticated) {
      ...
      if (postBtn) {
        postBtn.addEventListener('click', function() {
          console.log('[HeaderHome] Post button clicked');
      ...
      if (userBtn) {
        userBtn.addEventListener('click', function() {
          ...
          console.log('[HeaderHome] User button clicked', { username });
          if (username) {
      ...
      if (logoutBtn) {
        logoutBtn.addEventListener('click', function() {
          console.log('[HeaderHome] Logout button clicked');
          auth.logout();
        });
      }
    }
    ...
    window.addEventListener('user-authenticated', async (e) => {
      console.log('[HeaderHome] User authenticated, updating header');
    ...
    window.addEventListener('user-unauthenticated', async () => {
      console.log('[HeaderHome] User unauthenticated, updating header');
