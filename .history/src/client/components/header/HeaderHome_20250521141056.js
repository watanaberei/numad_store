...
const HeaderHome = {
  render: async () => {
    ...
    <div class="nav-main-right-container">
      <button id="btn-post" class="btn-nav"><i class="icon-plus"></i> Post</button>
        ...
        <section class="grid05 base nav-main">
              ...
              <div class="col01 nav-main-left left">
                ...
                <div class="nav-main-right right">
                  <div class="nav-main-right-container">
                    ${isAuthenticated ? `
                      <button id="OLD_btn-user" class="btn-nav">${userEmail}</button>
                      <button id="OLD_btn-logout" class="btn-nav">Log out</button>
                    ` : `
                      <button id="OLD_btn-login" class="btn-nav modal-btn" data-target="auth-modal">Login</button>
                    `}
                    ${ UserAccount }
                  </div>
                </div>
