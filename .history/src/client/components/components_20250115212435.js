...
export const storeService = {
 render: (header, text, categoryData, footerData) => {     
...
export const storeBusiness = {
  render: (header, timelineData, footerData) => {
    return `
      <div class="col04 array" id="header">
        ${header ? sectionHeader.render(header) : ''}
      </div>
...
export const storeLocation = {
  render: (header, attributeData, footerData) => {
    console.log('storeLocation render with data:', { header, attributeData, footerData });
    return `
      <div class="col04 array" id="header">
        ${header ? sectionHeader.render(header) : ''}
      </div>
...
export const storeExperience = {
 render: (header, text, area, attribute, footerData) => {     
