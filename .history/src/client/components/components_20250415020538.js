  ...
  render: (data) => {
    ...
    return `
     ...
     <div class="store-controls hero-controls array col01">
      ...
      <div id="Impression" class="user-impression disabled">
        <button class="impression-button like" id="userImpression like" data-store-id="${storeId}" onclick="storeActions.toggleImpression('${storeId}', 'like')">
          $ {glyph.glyphSymbolUserImpressionLike}
          <span class="count">${data.likes || 0}</span>
        </button>
        <button class="impression-button dislike" id="userImpression dislike" data-store-id="${storeId}" onclick="storeActions.toggleImpression('${storeId}', 'dislike')">
