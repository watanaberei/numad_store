...
<!--
  ...
  <div id="myModalAuth" class="modal hide">
    <div class="modal-content">
      <span class="modal-close">&times;</span>
      <div class="gallery mediaGallery">
        ${modalAuthDom}
   ...
   const after_render = async () => {
    ...
    document.addEventListener('click', (event) => {
      if (event.target.matches('.modal-close') || event.target.matches('.modal')) {
        document.getElementById('myModalAuth').classList.remove('show');
        document.getElementById('myModalAuth').classList.add('hide');
      } else if (event.target.matches('#auth-btn')) {
        document.getElementById('myModalAuth').classList.remove('hide');
        document.getElementById('myModalAuth').classList.add('show');
      }
    });
  };
  //  const after_render = async () => {
