...
function initAuthForms() {
  ...
  if (emailCheckForm) {
    emailCheckForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        console.log(`[modal] Sending auth check request to http://localhost:4000/auth`);
        ...
        console.log(`[modal] Auth check response status: ${response.status}`);
        const data = await response.json();
        console.log(`[modal] Auth check response data:`, data);
        ...
        console.error('[modal] Error checking email:', error);
  ...
  export const modalGallery = (modalGalleryData) => {
    ...
    const modalHTML = `
      ...
      <div id="myModal" class="modal grid05">
        <div class="modal-content col03 row01">
