...
// Modal system object to handle all modal operations
const modalSystem = {
...
export const modals = {
  init: () => {
    ...
    const modalElements = document.querySelectorAll('.modal'); // Fixed: was using 'modals' variable
    ...
    return modalSystem; // Return the modal system object
  }
};
