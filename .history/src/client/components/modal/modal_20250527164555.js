...
function handleAuthClick(e) {
  if (e.target.id === '#auth-modal, #btn-login') {
...
// Render login form with pre-filled identifier
  ...
  content.innerHTML = `
    <div class="auth-form-container">
      ...
      <div class="auth-switch">
        ...
        <p>Not you? <a href="#" class="switch-to-signup">Create account</a></p>
      </div>
    </div>
  `;
...
// Render signup form with pre-filled identifier
