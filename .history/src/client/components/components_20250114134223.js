...
export const storeDetail = {
 render: (data) => {
   console.log('storeDetail rendering with data:', data);
    ...
    const storeType = Array.isArray(data.storeType) ? data.storeType.map(StoreType => ({
      storeType: StoreType.title
    })) : [];
    console.log('&&& log: storeDetail11 - storeType:', storeType);
   return `
     <div class="hero-detail array col04">
       ...
       <div class="hero-secondary tag-array">
         <span class="objtag info-type text02">${storeType}</span>
