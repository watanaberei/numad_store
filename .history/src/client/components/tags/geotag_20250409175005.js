...
export const geotagType = {
  ...
  export const geotagStore = {
    render: (data) => {
      ...
      return `
        <button class="geotag grid02 tag primary">
          <span class="left primary text02  col01 row01">
            ${title}
          </span>
          <span class="right secondary text02 col01 word">
            ...
            <span class="text02">${storeRange}mi</span>
          </span>
        </button>
      `;
    }
  ...
  export const geotagStatus = {
    render: (data) => {
      // const icon = glyph.glyphDetailPrice;
      console.log('[geotag.geotagStatus] render called with:', data);
      const status = data;
      return `
        <button class="geotag tag">
