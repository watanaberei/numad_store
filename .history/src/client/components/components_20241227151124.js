...
export const storeLocation = {
  render: (locationHeaderData, locationAttributeData, locationFooterData) => {
    console.log('storeLocation render with locationData:', locationAttributeData);
    ...
    return `
      ...
      <div class="col04 container body">
        <div class="col04" id="mapNearby">
          ${mapNearby.render({
            address: locationAttributeData?.address,
            coordinates: locationAttributeData?.coordinates,
            area: locationAttributeData?.area
          })}
        </div>
        ${dividerComponent.render()}
        <div class="col04 array content">
  ...
  afterRender: () => {
    ...
    if (mapContainer) {
      console.log('debug log: storeLocation11 - Found map container');
