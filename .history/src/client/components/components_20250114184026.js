...
export const storeOverview = {
 render: (data) => {
  ...
  console.log('(00: overviewData', overviewData);
   return `
       <div class="col04 array" id="header">
         ${overviewData.headerData ? sectionHeader.render(overviewData.headerData) : ''}
       </div>
      
       <div class="col04 container body">
         ${overviewData.summaryData ? storeSummary.render(overviewData.summaryData) : ''}
         ${dividerComponent.render()}
         <div class="col04 " id="text">
           ${overviewData.textData ? textBlock.render(overviewData.textData) : ''}
         </div>
       </div>
      
    
       <div class="col04" id="footer">
         ${overviewData.footerData ? sectionFooter.render(overviewData.footerData) : ''}
       </div>
