...
function generateCarouselItem(content) {
  ...
  // const carousel = document.createElement("a");
  carouselItem.className = "card-carousel" + " " + "store" + " " + "col01";
  carouselItem.href = "/" + variant + "/" + slug;
  carouselItem.rel = "noopener noreferrer nofollow";
  carouselItem.target = categoryType + "-${store.sys.id}";
