...
//         galleryHTML += `
//           <img src="${galleryItem}" id="image${index.toString().padStart(2, '0')}" class="image ratio1x1" alt="" />
//         `;
//       })}
//     </div>
//     `;
...
function generateGalleryHTML(gallery) {
  ...
  gallery.slice(0, 3).forEach((galleryItem) => {
    galleryHTML += `
    <img src="${galleryItem.url}" id="image${index.toString().padStart(2, '0')}" class="image ratio1x1" alt="" />
