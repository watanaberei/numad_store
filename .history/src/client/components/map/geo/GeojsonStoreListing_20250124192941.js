...
function generateGalleryHTML(gallery) {
  console.log("!00: gallery data received:", gallery);
  ...
  gallery.slice(0, 3).forEach((galleryItem) => {
    ...
    console.log("!01: Processing gallery item:", galleryItem, "imageUrl:", imageUrl);
    ...
    galleryHTML += `
      <img src="${imageUrl}" class="galleryItem ratio1x1" alt="" />
    `;
  });
