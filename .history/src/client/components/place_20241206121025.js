...
export const businessHours = {
    render: (schedule) => {
      ...
      return array.create.createTimeline(
        {
          render: (hourSlot) => `
            <div class="hour-slot datavis-item ${hourSlot.status}" data-hour="${hourSlot.hour}">
              <div class="hour-marker">
                <span class="text02">${hourSlot.hour}:00</span>
              </div>
              <div class="hour-info">
                <div class="info-content">
                  <span class="text02">${hourSlot.info.time}</span>
                  <span class="text02">${hourSlot.info.activity}</span>
                </div>
              </div>
            </div>
          `
