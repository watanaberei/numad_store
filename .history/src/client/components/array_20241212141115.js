...
export const create = {
  ...
  createDatavis: (
    ...
    <div class="business-hours col04">
      <div class="container col04 ${style}" data-datavis-type="${type}">
        ...
        <div id="datavis" class="datavis datavis-track grid08-overflow">
          ${processedData
            .map(
              (item) => `
      ...
      <div id="datavis-control" class="tools">

        ${datavisControl.render({
  ...
  initializeDatavis: (datavisType) => {
    ...
    control.datavisControl.initialize('datavis-control');
