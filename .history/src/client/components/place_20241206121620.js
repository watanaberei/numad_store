...
export const businessHours = {
    render: (schedule) => {
      ...
      return array.create.createTimeline(
        {
          render: (datavis) => `
            <div id="time" class="datavis-item ${datavis.status}" data-hour="${datavis.hour}">
                <div class="datavis">
                    <div class="datavis-container" id=””>
                    <div class="datavis-active">${datavis.info.activity}</div>
                    </div>
                </div>
              ...
              <div class="time">
                <span class="text02 word">
                  <span id="time-hour" class="text02">${datavis.info.time}</span>
                  <span id="time-meridian" class="text02">${datavis.info.merdian}</span>
                </span>
              </div>
            </div>
          `
