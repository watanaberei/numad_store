...
const createStoreCard = {
  ...
  `;
    ...
    const iconPin  = icon.glyphLocationPin.render();
    const iconRating = icon.glyphRatingStar.render();
        ...
        resolve(`
           <div class="card col01"
            ...
            <div class="bottom secondary">
              <div class="pill">
                <span class="title text02 left">${storeData.title}</span>
                <span class="miles text02 word right">
                  ${iconPin}
                  ${storeData.distance}
                </span>
              </div>
