...
const createStoreCard = {
  ...
  `;
   ...
   const infoTagCityData = {
    ...
    console.log("storeEyebrow in card-store:", storeEyebrow);
    const storeRange = storeEyebrow.storeRange || '';
    console.log("storeRange in card-store:", storeRange);
    const renderedEyebrow = storeEyebrow.render(storeEyebrow.storeCurrentStatus, storeEyebrow.storeRange);
    ...
    const cardEyebrow = renderedEyebrow.render(storeEyebrow.storeCurrentStatus, storeEyebrow.storeRange);
    console.log("cardEyebrow in card-store:", cardEyebrow);
