    ...
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve(`
           ...
           <div class="primary">
             ${gallery.amtagGroup.render({ category: gallery.type })}
             ${
              gallery.source?.logo
                 ? `
               <div class="badge">
                 <img src="${gallery.source.logo}" alt="Partner logo" class="partner-logo-thumbnail" width="15" height="15">
               </div>
             `
                 : ""
             }
           ...
           <div class="content">
             <img src="${gallery}" alt="${gallery.name}" />
             <div class="item-info">
               <span class="name text02">${gallery.name}</span>
               <span class="type text02">${gallery.type}</span>
             </div>
           </div>
         </div>
