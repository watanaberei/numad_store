    ...
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve(`
           ...
           <div class="primary">
             ${storeData.amtagGroup.render({ category: storeData.type })}
             ${
              storeData.source?.logo
                 ? `
               <div class="badge">
                 <img src="${storeData.source.logo}" alt="Partner logo" class="partner-logo-thumbnail" width="15" height="15">
               </div>
             `
                 : ""
             }
           ...
           <div class="content">
             <img src="${storeData}" alt="${storeData.name}" />
             <div class="item-info">
               <span class="name text02">${storeData.name}</span>
               <span class="type text02">${storeData.type}</span>
             </div>
           </div>
         </div>
