...
const createStoreCard = {
  ...
  `;
    ...
    const storeRange = null;
    const storeType = storeData.categoryType;
   ...
   const infoTagCityData = {
    ...
    const storerange = getStoreRange();
    console.log("storerange", getStoreRange); // should print the value of storeRange
    ...
    const geotagRating = geotag.geotagRating.render(rating);
    const geotagType = geotag.geotagType.render(geotagTypeData);
            ...
            <div class="gridCard col01 row01 overlay">
              ...
              <div class="col01 row01  bottom secondary">
                <div class="col01 grid02 pill">
                  ${geotagStore}  ${stattagRange}
                </div>
              </div>
            </div>
            <div class=".bacground zmedia">
              ${mediaThumbnail}
            </div>
          <!--</div>-->
