...
import * as cardStore from "../../cards/_archive/card-store.js"
...
const createStoreCard = {
  ...
  `;
   ...
   const infoTagCityData = {
    ...
    // const mediaThumbnail = media.cardGalleryItem.render(gallery, galleryLimit);
    ...
    const mediaThumbnail = cardStore.thumbnail.render(gallery, galleryLimit);
