  ...
  render: (data) => {
    ...
    return `
      <a href="/@Neumad/${data.title || ''}"  class="card-blog col01"  >
        <div class="blog-content col01">
          <div class="blog-thumbnail col01">
            <img src="${data.thumbnail || ''}" alt="${data.title || 'Blog post'}" class="thumbnail-img" />
          </div>
          
          <div class="blog-info col01">
            <div class="blog-category col01">
              <i class="icon-${data.category || 'dine'}"></i>
              <span class="blog-category-text text01">${data.category || 'Article'}</span>
            </div>
            
            <div class="blog-title col01">
              <span class="text03 bold">${data.title || ''}</span>
            </div>
            
            <div class="blog-snippet col01">
              <span class="text02">${data.snippet || ''}</span>
            </div>
            
            <div class="blog-metadata col01">
              <div class="blog-tags col01">
                ${tagsHTML}
              </div>
              
              <div class="blog-date col01">
