...
// Add new control
// New addition: Control element for navigation
export const timelineNavigation = {
  // Initialize the navigation control
  init: (containerId) => {
      console.log(`Initializing timeline navigation for container: ${containerId}`);
      ...
      // Event listeners
      const prevButton = navigation.querySelector(".control-prev");
      const nextButton = navigation.querySelector(".control-next");

      prevButton.addEventListener("click", () => {
          console.log("Previous button clicked");
          // Add logic for previous navigation
      });

      nextButton.addEventListener("click", () => {
          console.log("Next button clicked");
          // Add logic for next navigation
      });
  },
};
