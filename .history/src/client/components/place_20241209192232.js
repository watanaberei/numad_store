...
export const businessHours = {
    render: (schedule) => {
      ...
      return array.create.createTimeline(
        {
          render: (datavis) => `
            <div id="time" class="col01 datavis-item time-item ${datavis.current ? "current" : ""}" data-hour="${datavis.hour}">
            ...
            <div id="time" class="datavis time-item ${datavis.current ? 'current' : ''}" data-hour="${datavis.hour}">
              <div class="datavis-visual">
                <div class="container ${datavis.status}">
                  <div class="status-indicator">${datavis.info.activity}</div>
                </div>
                <div class="datavis-item-details">
