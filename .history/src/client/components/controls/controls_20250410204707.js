      ...
      <!--<div class="user-controls   info sentance alignV-center text02 col02">-->
        ...
        <div class="score   actions   controls col02 array  alignH-right">
          ...
          <div id="userImpression" class="impression disabled pair">
            ...
            <button class="impression-button like active  impression-item" onclick="storeActions.toggleImpression('${store.storeId}', 'like')">
              <span class="text02 glyph">
                ${like}
                <span class="label">
            ...
            <button class="impression-button dislike   impression-item" onclick="storeActions.toggleImpression('${store.storeId}', 'dislike')">
              <span class="text02 glyph">
                ${dislike}
                <span class="label">
