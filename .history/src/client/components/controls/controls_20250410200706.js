...
export const controlUser = {
  render: (data) => {
    ...
    return `
    <div class="user-controls   content info sentance alignV-center text02 col02">
...
-->
        ...
        <div class="stamp   info sentance alignV-center text02 col02">
          ...
          <div class="modified sentance">
           <!-- <span class="label text02 sentance">-->
        ...
        <div class="actions">
          ...
          <div class="score   controls col02 array  alignH-right">
