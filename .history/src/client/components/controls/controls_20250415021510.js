      ...
      <!--<div class="user-controls   info sentance alignV-center text02 col02">-->
        ...
        <div class="score   actions   controls col02 array  alignH-right">
          ...
          <div id="Impressions" class="impression disabled pair">
            ...
            <span class="impression-item text02 glyph">
              <button id="userImpression like" class="impression-button like active" onclick="storeActions.toggleImpression('${store.storeId}', 'like')">
            ...
            <span class="impression-item text02 glyph">
              <button id="userImpression dislike" class="impression-button dislike" onclick="storeActions.toggleImpression('${store.storeId}', 'dislike')">
