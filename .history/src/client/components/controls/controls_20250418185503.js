...
//         <div class="stamp   info  alignV-center sentance text02 col02">
...
//         <div class="score   actions   controls col02 array  alignH-right">
...
//           <div id="Impressions" class="impression disabled pair">


//             <span class="impression-item text02 glyph">
//               <button id="userImpressions like" class="impression-button like" onclick="storeActions.toggleImpression('${store.slug || store.storeId}', 'like')">
...
//             <span class="impression-item text02 glyph">
//               <button id="userImpressions dislike" class="impression-button dislike" onclick="storeActions.toggleImpression('${store.slug || store.storeId}', 'dislike')">
  ...
  // render: (data, sectionID) => {
    ...
    return `
        ...
        <div class="score actions controls col02 array alignH-right">
          ...
          <div id="impressions" class="impression pair">
            <span class="impression-item text02 glyph">
              <button id="userImpressionslike" class="impression-button like" onclick="storeActions.toggleImpression('${store.slug || store.storeId}', 'like')">
                ${like}
                <span class="label">
                  ${countDefault.render(count.countLike)}
                </span>
            ...
            <span class="impression-item text02 glyph">
              <button id="userImpressionsdislike" class="impression-button dislike" onclick="storeActions.toggleImpression('${store.slug || store.storeId}', 'dislike')">
                ${dislike}
                <span class="label">
                  ${countDefault.render(count.countDislike)}
                </span>
...
//             <span class="impression-item text02 glyph">
//               <button id="userImpression dislike" class="impression-button dislike" onclick="storeActions.toggleImpression('${store.slug || store.storeId}', 'dislike')">
//                 ${dislike}
//                 <span class="label">
//                   ${countDefault.render(count.countDislike)}
//                 </span>
