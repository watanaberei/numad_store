      ...
      <div class="stamp">
        ...
        ${dividerV}
          ...
          <div id="userImpression" class="impression disabled">
            <button class="impression-button like active" onclick="storeActions.toggleImpression('${data.storeId}', 'like')">
              <i class="icon-user-rating-like-12px"></i>
              <span class="label">${countDefault.render(count.countLike)}</span>
            </button>

            <button class="impression-button dislike" onclick="storeActions.toggleImpression('${data.storeId}', 'dislike')">
