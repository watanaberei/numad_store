  ...
  render: (data) => {
    ...
    return `
     ...
     <div class="store-controls hero-controls array col01">
        ...
        <button class="store-controls user-action storeControls-visits" id="storeControls-visits" onclick="storeActions.toggleVisitedStore('${store.storeName}')">
          ${glyph.glyphControlVisited}
          <span class="text03">Visited</span>
        </button>
      </div>
...
//           <span class="text03">Save</span>
//         </button>
//         <button class="store-controls user-action storeControls-visits" id="storeControls-visits" onclick="storeActions.toggleCheckInStore('${store.storeName}', '${storeId}')">
...
//           <span class="text03">Save</span>
//         </button>
//         <button class="store-controls    user-action storeControls-visits"    id="storeControls-visits" onclick="storeActions.toggleCheckInStore('${store.storeName}')">
//           ${glyph.glyphControlCheckin}
//           <span class="text03">Check-in</span>
//         </button>
//       </div>
...
//         </button>
//         <button id="storeControls-visits" class="user-action storeControls-visits">
//           $ {glyph.glyphControlCheckin}
