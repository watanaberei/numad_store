...
//     media.slice(0, limit).forEach((item, index) => {
...
//            <div class="primary">
//               ${
//                 mediaThumbnailItem.source?.logo
//                   ? `
//                 <div class="badge">
//                   <img src="${mediaThumbnailItem.source.logo}" alt="Partner logo" class="partner-logo-thumbnail" width="15" height="15">
//                 </div>
//               `
//                   : ""
//               }
//             </div>
//             <div class="content">
//               <img src="${mediaThumbnailItem.thumbnail}" alt="${mediaThumbnailItem.name}" />
//               <div class="item-info">
//                 <span class="name text02">${mediaThumbnailItem.name}</span>
//                 <span class="type text02">${mediaThumbnailItem.type}</span>
//               </div>
//             </div>
