...
import * as controlTimeline from './controls.js'; // Add this import
import * as place from './place.js'; // Add this import


// const timelineControls = controlTimeline;
...
initializeTimeline: (timelineType) => {
  ...
  const controls = controlTimeline.initialize(timeline, {
