...
export const storeOverview = {
 render: (overviewHeaderData, overviewTextData, overviewSummaryData, overviewFooterData) => {
   return `
       <div class="col04 array" id="header">
         ${headerData ? sectionHeader.render(overviewHeaderData) : ''}
       </div>
       ...
       <div class="col04 container body">
         ...
         <div class="col04 " id="text">
           ${textData ? textBlock.render(overviewTextData) : ''}
         </div>
       </div>
      
    
       <div class="col04" id="footer">
         ${footerData ? sectionFooter.render(overviewFooterData) : ''}
       </div>
   ...
   return `
     ...
     <div class="col04 container body">
       <div class="col04 array content">
        ...
        //  })()}
        ${serviceCategoryData ? storeCategory.render(serviceCategoryData) : ''}
       </div>
       ${dividerComponent.render()}
       <div class="col04" id="text">
...
export const storeBusiness = {
  render: (businessHeaderData, businessTimelineData, businessFooterData) => {
    return `
      <div class="col04 array" id="header">
        ${businessHeaderData ? sectionHeader.render(businessHeaderData) : ''}
      </div>
      <div class="grid04-overflow array" id="business-hours">
        ${businessTimelineData ? storeBusinessTimeline.render(businessTimelineData) : ''}
      </div>
      <div class="col04" id="footer">
        ${businessFooterData ? sectionFooter.render(businessFooterData) : ''}
      </div>
    `;
  }
}
...
export const storeLocation = {
  render: (locationHeaderData, locationAttributeData, locationFooterData) => {
    console.log('storeLocation render with data:', { locationHeaderData, locationAttributeData, locationFooterData });
    return `
      <div class="col04 array" id="header">
...
export const storeExperience = {
 render: (experienceHeaderData, experienceTextData, experienceAreaData, experienceAttributesData, experienceFooterData) => {     
   console.log('storeExperience render with areaData:', experienceAreaData);
