...
export function initMap() {
    const map = new mapboxgl.Map({
        container: 'map',
        style: 'mapbox://styles/mapbox/streets-v11',  // Use a style that supports terrain
        center: [-77.034084142948, 38.909671288923],  // Set your initial map center
        zoom: 13,
        scrollZoom: false
      });
  ...
  map.on('load', function () {
    ...
    map.addSource('mapbox-dem', {
        'type': 'raster-dem',
        'url': 'mapbox://mapbox.terrain-rgb',  // This is a valid terrain source from Mapbox
        'tileSize': 512,
        'maxzoom': 14
      });
    ...
    buildLocationList(stores);
    addMarkers(map, stores);
       // Apply terrain settings to the map
       map.setTerrain({ source: 'mapbox-dem', exaggeration: 1.5 });
  });
