...
.sentance > div, .sentance > span, .sentance > o {
    height: 100%;
}
.glyph {
    display: flex !important;
...
globalStyleElement.textContent = globalStyle + globalType + globalText + globalControls + globalArrays + globalAlignment + globalDivider;
