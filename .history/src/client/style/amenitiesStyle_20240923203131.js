...
const amenitiesStyleElement = document.createElement(`style`);
amenitiesStyleElement.textContent = amenitiesStyle;
document.head.appendChild(amenitiesStyleElement);
