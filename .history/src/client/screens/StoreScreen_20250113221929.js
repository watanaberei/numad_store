...
const StoreScreen = {
        ...
        <div id="store" class="main grid05">
          <div id="section" class="hero col05">
            <div class="col05 array content" id="store-hero">
              ...
              ${components.storeHero.render({
                rating: hero.rating,
                costEstimate: hero.costEstimate,
                storeType: hero.storeType,
                distance: hero.distance,
                city: hero.city,
                state: hero.state,
                storeName: hero.storeName,
                distanceMiles: hero.distanceMiles,
                status: hero.status,
  ...
  after_render: async () => {
    try {
      ...
      components.storeOverview.afterRender();
      components.storeBusiness.afterRender();
      components.storeLocati
      ...
      // Initialize popular times if needed
      if (document.getElementById("chartsContainer")) {
        const popularTimesData = store?.popularTimes ? [store.popularTimes] : [];
