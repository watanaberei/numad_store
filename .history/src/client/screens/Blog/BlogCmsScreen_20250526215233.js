...
const PostScreen = {
  ...
  after_render: async () => {
    ...
    // Helper function to save post - UPDATED TO MATCH STORESCREEN PATTERN
    async function savePost(status, isAutosave = false) {
      try {
        ...
        // Create completeBlogData object similar to how StoreScreen creates completeStoreData
        const completeBlogData = {
          ...
          // Author info (get from localStorage or token)
          author: {
            id: 'current-user-id', // You'll need to get this from your auth system
            name: 'Current User', // You'll need to get this from your auth system
            email: 'user@example.com' // You'll need to get this from your auth system
          },
