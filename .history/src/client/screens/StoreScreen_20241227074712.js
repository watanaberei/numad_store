...
const StoreScreen = {
  ...
  <div class="item">
    ...
    const storeExperienceHTML = components.storeExperience.render(
      storeExperienceData.experience[0].header,
      storeExperienceData.experience[0].text,
      storeExperienceData.experience[0].footer,
      storeExperienceData.experience[0].area,
      storeExperienceData.experience[0].attribute
    );
    const storeServiceHTML = components.storeService.render(
      storeServiceData.service[0].header,
      storeServiceData.service[0].text,
      storeData.serviceCategoryData,
      storeServiceData.service[0].footer
    );
