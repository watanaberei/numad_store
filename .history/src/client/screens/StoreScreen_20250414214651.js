  ...
  toggleCheckInStore: function(storeName) {
    ...
    try {
      ...
      .then(data => {
        ...
        // Server responded successfully, no need to revert UI
      })
      .catch(error => {
        console.error('[StoreScreen.js.toggleCheckInStore] Error:', error);
        // Server error occurred, revert UI changes
        updateCheckInUI(!isCheckingOut);  // Revert by passing opposite state
