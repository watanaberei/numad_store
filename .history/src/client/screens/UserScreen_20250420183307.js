...
const UserScreen = {
  render: async () => {
    ...
    after_render: async () => {
      ...
      console.log('[UserScreen.checkedInStoresContent]', checkedInStoresContent);
      if (!checkedInStoresContent) {
        console.error('Could not find checkedInStoresContent element');
        return;
      }
      
      console.log('[UserScreen.accessToken] starting api request', accessToken);
      try {
        ...
        if (response.ok) {
          console.log('[UserScreen.response] successful api request');
          const checkedInStores = await response.json();
          console.log('[UserScreen.response.checkedInStores] Checked-in stores from API:', checkedInStores);
