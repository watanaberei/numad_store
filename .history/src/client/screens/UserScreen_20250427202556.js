...
const UserScreen = {
  render: async () => {
    ...
    const fieldText = form.fieldText;
    ...
    return `
      ...
      <div class="main col05">
        ...
        <div class="col02 profile-container">
          ${fieldText.render({ firstName || [] })}
          ${fieldText.render({ lastName })}
          ${fieldText.render({ birthdate })}
          ${fieldText.render({ description })}
          ${fieldText.render({ location })}
          ${fieldText.render({ website })}
          ${fieldText.render({ fullName })}
          ${fieldText.render({ phoneNumber })}
