  ...
  after_render: async () => {
    ...
    socket.on('impression_update', (data) => {
      ...
      if (data && data.storeId) {
        ...
        const likeButtons = document.querySelectorAll('#userImpressions.like');
        const dislikeButtons = document.querySelectorAll('#userImpressions.dislike');
...
window.storeActions = {
  ...
  // Update this in the window.storeActions object
