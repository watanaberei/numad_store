...
/* Header Post Button Integration */
...
/* Blog Cards in Home Screen */
.card-blogCarousel-item {
  display: block;
  text-decoration: none;
  color: inherit;
  transition: all 0.3s ease;
...
/* User Profile Blog Card Variants */
.card-blog-user {
  position: relative;
}
...
blogStyleElement.textContent = blogStyle + TempBlogStyle + blogCardStyle; 
