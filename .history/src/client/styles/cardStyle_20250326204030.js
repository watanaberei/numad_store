...
// card-collection {
//   background: var(--utility-tag, #9747ff);
...
a.card.store >.background {
  z-index: -1;
}
a.card.store > .overlay div {
  // height: fit-content;
  display: grid !important;
}

a.card.store > .overlay > .primary {
  // opacity: 0;
  display: flex;
  flex-direction: row;
...
a.card.store .overlay .secondary {
  // margin: -33333333458944px 0 0 0;
  // display: flex;
  // flex-direction: column;
  gap: 0px;
...
a.card.store .container .glyph-packed {
  padding: 6.23px 0px 5.79px 0px;
  display: flex;
  flex-direction: row;
  gap: 10px;
...
a.card.store .container .icon2 {
  flex-shrink: 0;
  width: 6.36px;
  height: 9px;
  position: relative;
}
a.card.store .container .hours {
  width: 6.38px;
  height: 8.98px;
  position: absolute;
  left: 0px;
...
a.card.store .container .pill-status {
  background: var(--ink-shade-03, #f2f4f5);
  border-radius: 15px;
  padding: 0px var(--ratio-spacer-s04, 6px) 0px var(--ratio-spacer-s04, 6px);
  display: flex;
...
a.card.store .container .ellipse-340 {
  background: var(--ink-shade-03, #f2f4f5);
  border-radius: 50%;
  flex-shrink: 0;
  width: 6px;
...
a.card.store .container .ellipse-342 {
  background: var(--ink-shade-03, #f2f4f5);
  border-radius: 50%;
  opacity: 0.45;
  flex-shrink: 0;
...
a.card.store .container .ellipse-343 {
  background: var(--ink-shade-03, #f2f4f5);
  border-radius: 50%;
  opacity: 0.45;
  flex-shrink: 0;
...
a.card.store .container .strawberry-match-latte {
  color: var(--utility-action, #3a3aff);
  text-align: left;
  font-family: "HelveticaNeue-Medium", sans-serif;
  font-size: 12px;
  line-height: 21px;
...
cardStyle.textContent = card + cardStoreStyle + cardGalleryStyle + cardOverlays + cardCategory + cardSubStore + cardCollection + cardSummary + cardAttributes;
