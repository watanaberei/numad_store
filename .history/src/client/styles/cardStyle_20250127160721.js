...
.gridCard.col01.row01 .background {
  z-index: -1;
}

.gridCard.col01.row01.overlay .primary {
  opacity: 0;
  display: flex;
  flex-direction: row;
...
.gridCard.col01.row01.overlay .tertiary {
...
.gridCard.col01.row01.overlay .secondary {
  margin: -33333333458944px 0 0 0;
  display: flex;
  flex-direction: column;
  gap: 0px;
