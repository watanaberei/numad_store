...
.timeline:hover .timeline-item-details {
  display: flex;
  flex-direction: column;
  alignItems: center;
  justifyContent: center;
}
.timeline .timeline-visual.active {
  background: var(--utility-rank-good03, #26e615);
}
.timeline .timeline-visual.inactive {
  background: #EAF2F4;
}
.timeline.current {
...
.business-hours {
 ...
 .timeline .timeline-item.active.current {
  display: flex;
  flex-direction: column;
  gap: 0px;
  align-items: flex-start;
 ...
 .timeline .timeline-indicator.active.current {
  background: var(--utility-rank-good03, #26e615);
  border-radius: var(--spacer-gap-s05, 9px);
  align-self: stretch;
  flex: 1;
 ...
 .timeline .timeline-info .primary {
  display: grid;
 ...
 .timeline .timeline-info .secondary {
  display: grid;
    /* background: aliceblue; */
    grid-row: span 1;
    grid-column: span 1;
 ...
 .timeline .timeline-info .indicator-live {
  border-radius: 333333px;
  border-style: solid;
  border-color: var(--utility-action, #3a3aff);
  border-width: 1px;
  padding: 1.5px;
  display: flex;
  flex-direction: row;
 ...
 .timeline .timeline-indicator.active {
 ...
 .timeline .timeline-item,  .timeline .timeline-item-inactive {
  display: flex;
  flex-direction: column;
  gap: 0px;
  align-items: flex-start;
 ...
 .timeline .timeline-indicator.inactive {
...
const timelineElement = document.createElement('style');
timelineElement.textContent = timelineStyle + timelineStyle;
document.head.appendChild(timelineElement);
