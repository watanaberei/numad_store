...
export const pill = `
.pill:has(>.tag) {
  margin: var(--spacer-gap-s02);
  // padding: 0px;s
  width: -webkit-fill-available;
  height: fit-content;
  gap: var(--spacer-gap-s05) !important;
  display: inline-table !important;
  background-color: unset !important;
  place-content: center !important;
  place-items: center !important;
  border-radius: var(--s07) !important;
  background-color: var(--bg-white-03) !important;
...
.pill .tag {
  ...
  place-items: center !important;
  display: inline-table !important;
  gap: var(--spacer-gap-s01) !important;
  // max-height: 21px !important;
  width: fit-content !important;
  place-content: center !important;
  place-items: center !important;
  padding: var(--spacer-gap-s04) var(--spacer-gap-s06)
  grid-template-row: 1fr;
}
.pill .tag.primary {
  box-sizing: border-box;
  display: grid !important;
  padding: var(--spacer-gap-s06) var(--spacer-gap-s06) !important;
...
tagStyleElement.textContent = tag + badge + pill +tagStyle + countStyle + labelStyle;
...
.tag.amtag {
  ...
  outline-width: 1px;
  width: fit-content;
  outline-color: var(--utility-action) !important;
  // position: relative;
  // transition: background-color 0.3s ease;
  // cursor: pointer;
  // display: inline-table !important;
...
.amtag.tag:hover .score-icons {
  ...
  left: 0;
  top: -100%;
  background-color: var(--bg-black-03) !important;
  width: fit-content;
  height: 100%;
  justify-content: 6px;
  align-items: center;
...
.tag.amtag.selected {
  background-color: var(--utility-action);
...
.tag.objtag {
  display: inline-table !important;
  background: var(--utility-action, #3a3aff);
  border-radius: var(--spacer-gap-s06, 12px);
  border-style: solid;
  border-color: var(--utility-action, #3a3aff);
  border-width: 1px;
