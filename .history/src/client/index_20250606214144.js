...
const routes = {
  ...
  "/Auth": AuthScreen,
  "/user": UserScreen,
  "/:username": UserScreen,  // Add dynamic user routing
  "/settings": SettingScreen,
  "/profile": ProfileScreen, 
  "/stores/:slug": StoreScreen,
  // "/map": MapScreen,
  "/post": PostScreen,
  "/post/:slug": PostScreen,
  "/:username/blog/:slug": BlogScreen,  // New pattern for viewing blog
  "/blog": BlogListScreen,
};
...
const router = async () => {
  ...
  if (parseUrl === "/:username/blog/:slug") {
    // header.innerHTML = await HeaderSecondary.render();
    // await HeaderSecondary.after_render();
    header.innerHTML = await HeaderHome.render();
    await HeaderHome.after_render();
  } else if (parseUrl === "/blog") {
    header.innerHTML = await HeaderHome.render();
    await HeaderHome.after_render();
  } else if (parseUrl === "/post" || parseUrl === "/:username/blog/:slug") {
