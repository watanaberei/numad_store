...
import ProfileScreen from "./screens/User/ProfileScreen.js";  // FIXED: Use ProfileScreen for @username routes
...
const routes = {
  ...
  "/post": PostScreen,
  "/@:username": ProfileScreen,           // FIXED: Use ProfileScreen for user profiles
  "/@:username/setting": SettingScreen,   // Settings page
  "/@:username/:blog": BlogScreen,        // Blog posts
  "/@:username/:blog/edit": PostScreen,   // Blog editing
  "/:slug": StoreScreen,                  // Store pages
};
...
// Handle navigation link clicks (duplicate handling removed)
document.body.addEventListener('click', e => {
  // Handle both data-link and regular anchor tags within the app
  const link = e.target.closest('[data-link], a');
  if (link && link.href && link.host === window.location.host) {
