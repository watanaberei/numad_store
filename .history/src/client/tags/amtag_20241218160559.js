...
export const amtagScore = {
  render: (data) => {
    ...
    return `
      ${tags.map(tag => {
        ...
        return `
          <button id="score" class="amtag tag" id="amtag" data-name="value" data-score="${tag.score}">
  ...
  createScoreWidget: (tag) => {
    console.log('createScoreWidget initiated');
    let amtagScoreButton = document.querySelector('#score.amtag.tag');

    // amtagScoreButton.addEventListener("mouseenter", () => { 
    //   console.log('Mouse entered the button');
    //   amtagScoreButton.classList.add('active');
    // }
