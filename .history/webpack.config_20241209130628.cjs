...
module.exports = {
  ...
  entry: {
    ...
    style: './src/client/style/style.js',
  },
  ...
  resolve: {
    alias: {
      ...
      // Styles: path.resolve(__dirname, "src/client/style"),
    },
    fallback: {
      "os": false,
      "tls": false,
  ...
  devServer: {
    static: {
      directory: path.resolve(__dirname, './src/client/style/style.js'),
    },
    proxy: {
      '/api': {
  ...
  // devServer: {
  //   static: {
  //     directory: path.resolve(__dirname, './src/client/style/'),
  //   },
  //   proxy: [{
  //     context: ['/api'],
